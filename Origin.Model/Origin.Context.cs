...
namespace Origin.Model
{
    ...
    public partial class OriginEntities : DbContext
    {
        public OriginEntities()
            : base("name=OriginEntities")
        {
        }
        ...
        public virtual ObjectResult<GetModulesByRole_Result> GetModulesByRole(string roleId)
        {
            var roleIdParameter = roleId != null ?
                new ObjectParameter("roleId", roleId) :
                new ObjectParameter("roleId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetModulesByRole_Result>("GetModulesByRole", roleIdParameter);
        }
    
        public virtual ObjectResult<P_Sys_GetRightOperate_Result1> P_Sys_GetRightOperate(Nullable<int> userId, string url)
        {
